...
| `price_per_minute` | `Int32` | Цена за минуту в рублях. |
| `price_unlock` | `Int32` | Цена разблокировки в рублях. |
| `deposit` | `Int32` | Сумма депозита в рублях. |
| `total_amount` | `Int32` | Общая стоимость заказа в рублях. |
